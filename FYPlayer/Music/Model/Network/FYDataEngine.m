    ...
    [op addCompletionHandler:^(MKNetworkOperation *completedOperation) {
        ...
        @try{
            ...
            if ([[dictionary allKeys] count]>1) {
                ...
                BOOL  sucess = [FYSinger insertToDB:model];
                if (sucess) {
                                ...
                                errorHandler:(MKNKErrorBlock)errorHandler
{
    ...
    [op addCompletionHandler:^(MKNetworkOperation *completedOperation) {
        ...
        //        NSLog(@"resp:%@",respJson);
        FYMySongList * list = [FYMySongList new];
        @try{
            NSDictionary * dictionary = respJson;
            if ([[dictionary allKeys] count]>1) {
                ...
                for (NSDictionary * dict in temp) {
                    FYSongList * model = [FYSongList new];
                                 ...
                                 errorHandler:(MKNKErrorBlock)errorHandler
{
    ...
    FYNetworkEngine * netwrok = [self initWithHostName:@"ting.baidu.com"];
